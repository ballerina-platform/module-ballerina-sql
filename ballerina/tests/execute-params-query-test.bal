...
function deleteDataTable1() returns error? {
    ...
    string stringType = "Hello";
    decimal decimalType = 23.45;
    ParameterizedQuery query1 = `DELETE FROM DataTable where row_id=${rowId} AND`;
    ParameterizedQuery query2 = ` int_type=${intType} AND long_type=${longType} AND`;
    ParameterizedQuery query3 = ` float_type=${floatType} AND double_type=${doubleType}`;
    ParameterizedQuery query4 = ` AND boolean_type=${boolType} AND string_type=${stringType}`;
...
function deleteDataTable4() returns error? {
    int rowId = 10;
    int intType = 1;
    int longType = 9223372036854774807;
    float floatType = 123.34;
    ...
    ParameterizedQuery query4 = ` float_type=${floatType} AND double_type=${doubleType}`;
...
function deleteDataTable5() returns error? {
    int rowId = 11;
    int intType = 1;
    int longType = 9223372036854774807;
    float floatType = 123.34;
...
function deleteDataTable6() returns error? {
    int rowId = 1;
    int intType = 1;
    int longType = 9223372036854774807;
    float floatType = 123.34;
